...
> This optional Filament 5 presentation package presents exactly one independent domain module. It contributes reusable resources, pages, widgets, schemas, tables, infolists, and actions to application-owned panels while delegating authorization, validation, tenancy, persistence, and business rules to the cms-hook-and-event-sdk public boundary. It
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-hook-and-event-sdk-filament?sort=semver)](https://github.com/liberusoftware/module-cms-hook-and-event-sdk-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-hook-and-event-sdk-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-hook-and-event-sdk-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-hook-and-event-sdk-filament
```
...
<a href="https://github.com/liberusoftware/module-cms-hook-and-event-sdk-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-hook-and-event-sdk-filament" alt="Contributors to liberusoftware/module-cms-hook-and-event-sdk-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-hook-and-event-sdk-filament/graphs/contributors).
